...
#
# dma_dac_project.tcl: Tcl script for re-creating project 'dma_dac'
#
# Generated by Vivado on Wed Jan 07 18:13:14 +0530 2026
...
#
# 1. This project restoration tcl script (dma_dac_project.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/SUJAL_FCRITINTERN/dma_dac/dma_dac.srcs/utils_1/imports/synth_1/dma_dac_bd_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../SUJAL_FCRITINTERN/dma_dac/dma_dac.srcs/utils_1/imports/synth_1/dma_dac_bd_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set script_file "dma_dac_project.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../SUJAL_FCRITINTERN/dma_dac"]"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "dma_dac_bd_wrapper" -objects $obj
...
set file "synth_1/dma_dac_bd_wrapper.dcp"
...
# Proc to create BD dma_dac_bd
proc cr_bd_dma_dac_bd { parentCell } {
...
# End of cr_bd_dma_dac_bd()
cr_bd_dma_dac_bd ""
set_property REGISTERED_WITH_MANAGER "1" [get_files dma_dac_bd.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files dma_dac_bd.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse dma_dac_bd.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../SUJAL_FCRITINTERN/dma_dac/dma_dac.gen/sources_1/bd/dma_dac_bd/hdl/dma_dac_bd_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse dma_dac_bd.bd] -top]
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/dma_dac.srcs/utils_1/imports/synth_1/dma_dac_bd_wrapper.dcp" -objects $obj
