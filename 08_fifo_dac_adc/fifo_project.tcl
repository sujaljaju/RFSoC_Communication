...
#
# fifo_project.tcl: Tcl script for re-creating project 'dac_adc_loopback_definitely_not_final'
#
# Generated by Vivado on Wed Jan 07 18:08:39 +0530 2026
...
#
# 1. This project restoration tcl script (fifo_project.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/vivado_practice/copy_dac1/dac_adc_loopback_definitely_not_final/dac_adc_loopback_definitely_not_final.srcs/utils_1/imports/synth_1/dac_adc_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../vivado_practice/copy_dac1/dac_adc_loopback_definitely_not_final/dac_adc_loopback_definitely_not_final.srcs/utils_1/imports/synth_1/dac_adc_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "dac_adc_loopback_definitely_not_final"
...
set script_file "fifo_project.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../vivado_practice/copy_dac1/dac_adc_loopback_definitely_not_final"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../Users/user/AppData/Roaming/Xilinx/Vivado/2022.1/xhub/board_store/xilinx_board_store"]" -objects $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse dac_adc.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../vivado_practice/copy_dac1/dac_adc_loopback_definitely_not_final/dac_adc_loopback_definitely_not_final.gen/sources_1/bd/dac_adc/hdl/dac_adc_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/dac_adc_loopback_definitely_not_final.srcs/utils_1/imports/synth_1/dac_adc_wrapper.dcp" -objects $obj
